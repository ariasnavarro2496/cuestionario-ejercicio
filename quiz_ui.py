...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain) -> None:
        ...
        self.window = Tk()
        self.window.title("App Cuestionario")
    ...
    def display_title(self):
        ...
        # Title
        title = Label(self.window, text="Cuestionario",
    ...
    def next_btn(self):
        ...
        if self.quiz.check_answer(self.user_answer.get()):
            ...
            self.feedback["text"] = 'Correcta \U0001F44D'
        else:
            self.feedback['fg'] = 'red'
            self.feedback['text'] = (
                                     f'Respuesta incorrecta: {self.quiz.current_question.correct_answer}')
    ...
    def buttons(self):
        ...
        # next Question
        next_button = Button(self.window, text="Siguiente", command=self.next_btn,
        ...
        quit_button = Button(self.window, text="Salir", command=self.window.destroy,
    ...
    def display_result(self):
        ...
        correct = f"Correctas: {correct}"
        wrong = f"Incorrectas: {wrong}"

        # calculates the percentage of correct answers
        result = f"Puntaje: {score_percent}%"
